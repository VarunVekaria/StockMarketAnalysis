...
// 			<div
// 				className="container"
// 				style={{ justifyContent: "flex-start", padding: "0 0 0 18%" }}
// 			>
// 				<div className="card">
// 					<div className="content">
// 						<h1>1</h1>
// 						<h3>Enter the stock of your preference</h3>
...
// 			<div
// 				className="container"
// 				style={{ justifyContent: "flex-end", padding: "0 12% 0 0" }}
// 			>
// 				<div className="card">
// 					<div className="content">
// 						<h1>2</h1>
// 						<h3>Enter the time granularity</h3>
// 					</div>
// 				</div>
// 			</div>
...
// 			<div
// 				className="container"
// 				style={{ justifyContent: "flex-start", padding: "0 0 0 11%" }}
// 			>
// 				<div className="card">
// 					<div className="content">
// 						<h1>3</h1>
// 						<h3>Voila! we have the predicted graph</h3>
// 					</div>
// 				</div>
// 			</div>
// 		</div>
